...
%% train SVM
[lossPert, accPert, thetaPert] = trainMulticlass([X_train;X_pert], [y_train;y_pert], k, 0.005, 1e-4, N_train+N_pert, d, 1000); %99999);
[lossPertBad, accPertBad] = testMulticlass(X_pert, y_pert, k, N_pert, d, thetaPert, 2500); %99999);
[lossPertTest, accPertTest] = testMulticlass(X_test, y_test, k, N_test, d, thetaPert, 2500); %99999);

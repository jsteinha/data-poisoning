function [rho_plus, rho_minus, xb_plus, xb_minus] = createAttackProj(t, rho_plus, rho_minus, epsilon, Psi_half, Sigma_proj_plus, Sigma_proj_minus, mu_proj_plus, mu_proj_minus, p_plus, p_minus, Q)
  d_proj = size(Q,1);
  ...
  residual_plus  = Psi_half * (xb_plus - mu_proj_plus);
  residual_minus = Psi_half * (xb_minus - mu_proj_minus);
  max_err = sdpvar(1,1);

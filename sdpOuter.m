...
for major_iter = 187:1000
    ...
    while iter < MAX_ITER
        ...
        [G, C, G_v, A, X_plus, X_minus, w_nom] = sdpSmall(epsilon, [mu_plus mu_minus], probs, r_sphere, r_slab, opts, ... 
                                                                     [M_theta;M_nn], ...
                                                                     [y_theta;y_nn], ...
                                                                     [h_theta;h_nn], 50);
...
%    end
    ...
    [g,L0] = nabla_Loss(X_train, y_train, thetaPert);
    losses = [losses L0];
    losses
    ...
    lossesFull
    [gnom,Lnom] = nabla_Loss(X_train, y_train, w_nom);
...
%     end
    ...
    if xb_plus' * thetaPert < 0.4 || xb_minus' * thetaPert > -0.4
...
%        norm_g = norm(g,2);
        ...
        M_theta = [M_theta; gnom'];
        y_theta = [y_theta; (L0full - Lnom) - epsilon + gnom' * w_nom];
        h_theta = [h_theta; 3];
    end
